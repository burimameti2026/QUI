...
@Component({
  ...
  styles: [`
    ...
    .kpi-icon{position:absolute;top:15px;right:17px;display:grid!important;width:25px;height:25px;place-items:center;border:1px solid #dfe3e7;border-radius:3px;background:var(--wl-surface,#fff);color:#8a8f96!important;font-size:10px!important}
