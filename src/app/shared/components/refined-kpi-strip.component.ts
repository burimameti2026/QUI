...
@Component({
  ...
  styles: [`
    ...
    .refined-kpi-strip>article:nth-child(2):before{background:#64748b}.refined-kpi-strip>article:nth-child(3):before{background:#16a34a}.refined-kpi-strip>article:nth-child(4):before{background:#f97316}.refined-kpi-strip>article:nth-child(5):before{background:#f97316}
    ...
    .refined-kpi-strip>article:first-child .kpi-icon{color:#f97316!important;border-color:#fed7aa;background:#fff7ed}
    .refined-kpi-strip>article:nth-child(3) .kpi-icon{color:#16a34a!important;border-color:#bbf7d0;background:#f0fdf4}
    .refined-kpi-strip>article:nth-child(4) .kpi-icon{color:#f97316!important;border-color:#fed7aa;background:#fff7ed}
