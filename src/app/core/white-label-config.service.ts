...
export class WhiteLabelConfigService {
  ...
  private normalizeStyles(styles:any):WhiteLabelStyles {
    ...
    const ORANGE='#f5500bdb'; const ORANGE_HOVER='#000000'; const ORANGE_SOFT='#fff4df'; const ORANGE_BORDER='#ffd08a';
