...
const T: Record<string, Record<AdminLanguage,string>> = {
  ...
  'Total':{en:'Total',mk:'Вкупно',sq:'Gjithsej',de:'Gesamt'},'Hot':{en:'Hot',mk:'Жежок',sq:'I nxehtë',de:'Heiß'},'Value':{en:'Value',mk:'Вредност',sq:'Vlera',de:'Wert'},
  ...
  'Loading leads…':{en:'Loading leads…',mk:'Се вчитуваат лидови…',sq:'Duke ngarkuar leads…',de:'Leads werden geladen…'},
  'No matching leads':{en:'No matching leads',mk:'Нема соодветни лидови',sq:'Nuk ka leads që përputhen',de:'Keine passenden Leads'},
  ...
  'Lead':{en:'Lead',mk:'Лид',sq:'Lead',de:'Lead'},'Score':{en:'Score',mk:'Резултат',sq:'Rezultat',de:'Score'},'Temperature':{en:'Температура',mk:'Температура',sq:'Temperatura',de:'Temperatur'},'Status':{en:'Status',mk:'Статус',sq:'Statusi',de:'Status'},'Est. value':{en:'Est. value',mk:'Проценета вредност',sq:'Vlera e përafërt',de:'Geschätzter Wert'},'Actions':{en:'Actions',mk:'Акции',sq:'Veprime',de:'Aktionen'},
