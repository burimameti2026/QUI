...
export const ADMIN_PAGE_COPY_TRANSLATIONS: Record<string, Record<AdminLanguage, string>> = {
  ...
  'Manage product information, markets, languages and publication from one workspace.': { en: 'Manage product information, markets, languages and publication from one workspace.', mk: 'Управувајте со производи, пазари, јазици и објавување од еден работен простор.', sq: 'Menaxhoni produktet, tregjet, gjuhët dhe publikimin nga një hapësirë pune.', de: 'Produkte, Märkte, Sprachen und Veröffentlichungen in einem Arbeitsbereich verwalten.' },
  ...
  'Turn selected companies into a reusable campaign audience.': { en: 'Turn selected companies into a reusable campaign audience.', mk: 'Претворете ги избраните компании во публика за повторна употреба во кампањи.', sq: 'Kthejini kompanitë e zgjedhura në audiencë të ripërdorshme për fushata.', de: 'Ausgewählte Unternehmen in eine wiederverwendbare Kampagnenzielgruppe umwandeln.' },
  ...
  'Add the first product to start the promotion workflow.': { en: 'Add the first product to start the promotion workflow.', mk: 'Додајте го првиот производ за да го започнете текот на промоцијата.', sq: 'Shtoni produktin e parë për të nisur rrjedhën e promovimit.', de: 'Fügen Sie das erste Produkt hinzu, um den Promotions-Workflow zu starten.' },
