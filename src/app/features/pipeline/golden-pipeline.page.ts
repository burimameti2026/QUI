...
.golden-board{margin:0 28px 18px;padding:8px!important;border:1px solid #e5e9f0!important;border-radius:10px!important;background:#eef2f7!important;box-shadow:0 1px 2px rgba(16,24,40,.03),0 4px 14px rgba(36,60,88,.045)!important}
