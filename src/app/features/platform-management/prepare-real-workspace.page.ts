...
@Component({
  ...
  `,
  styles: [`
    :host{display:block;min-height:100%;background:var(--qui-bg);color:var(--qui-text)}
    .eyebrow{display:block;color:var(--qui-faint);font-size:var(--qui-text-xs);font-weight:800;letter-spacing:.11em}
    .steps{display:flex;gap:8px;margin:0 28px 14px;flex-wrap:wrap}
    .steps span{display:flex;align-items:center;gap:8px;min-height:34px;padding:0 11px;border:1px solid var(--qui-border);border-radius:var(--qui-radius-md);background:var(--qui-surface);color:#7b8798;font-size:var(--qui-text-xs);font-weight:700}
    .steps span b{display:grid;place-items:center;width:22px;height:22px;border-radius:var(--qui-radius-md);background:#f2f4f7;color:var(--qui-faint);font-size:var(--qui-text-xs)}
    .steps .active{border-color:#fed7aa;background:var(--qui-accent-soft);color:#c2410c}.steps .active b{background:#ffedd5;color:var(--qui-accent-hover)}
    .steps .done{color:var(--qui-text-soft)}.steps .done b{background:#eaf8ee;color:var(--qui-positive)}
    .section{margin:0 28px 14px;padding:20px;border:1px solid var(--qui-border);border-radius:var(--qui-radius-lg);background:var(--qui-surface);box-shadow:var(--qui-shadow-md)}
    .section-heading{margin-bottom:16px}.section-heading h2{margin:5px 0;color:var(--qui-text);font-size:var(--qui-text-2xl);line-height:1.2;font-weight:700;letter-spacing:-.02em}.section-heading p{max-width:760px;margin:0;color:var(--qui-muted);font-size:var(--qui-text-xs);line-height:1.55}
    ...
    .card{--accent:#f97316;--accent-soft:#fff7ed;position:relative;display:block;min-height:156px;padding:16px;overflow:hidden;border:1px solid var(--qui-border);border-radius:var(--qui-radius-lg);background:var(--qui-surface);box-shadow:0 1px 2px rgba(16,24,40,.03);transition:transform .14s ease,border-color .14s ease,box-shadow .14s ease}
    ...
    .card-number{position:relative;z-index:1;display:grid;width:31px;height:31px;place-items:center;margin-bottom:13px;border-radius:var(--qui-radius-md);background:var(--accent-soft);color:var(--accent);font-size:var(--qui-text-xs);font-weight:800}
    .card h3{position:relative;z-index:1;margin:0 0 6px;color:var(--qui-text);font-size:var(--qui-text-md)}.card p{position:relative;z-index:1;margin:0;min-height:32px;color:var(--qui-muted);font-size:var(--qui-text-xs);line-height:1.5}.card strong{position:relative;z-index:1;display:block;margin-top:13px;color:#c2410c;font-size:var(--qui-text-xs)}
    .form-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.form-grid label{display:flex;flex-direction:column;gap:6px;color:var(--qui-muted);font-size:var(--qui-text-xs);font-weight:700}.form-grid input,.form-grid select{width:100%;height:38px;padding:0 10px;border:1px solid var(--qui-border);border-radius:var(--qui-radius-md);background:var(--qui-surface);color:var(--qui-text);font-size:var(--qui-text-xs);outline:0}.form-grid input:focus,.form-grid select:focus{border-color:#fdba74;box-shadow:0 0 0 3px rgba(249,115,22,.08)}
    .automation{margin-top:14px;padding:15px;border:1px solid var(--qui-border);border-radius:var(--qui-radius-md);background:var(--qui-surface-muted)}.automation-heading{display:flex;flex-direction:column;gap:4px}.automation-heading strong{color:var(--qui-text);font-size:var(--qui-text-sm)}.automation-heading small{color:var(--qui-faint);font-size:var(--qui-text-xs)}.pipeline{display:grid;grid-template-columns:repeat(9,minmax(0,1fr));align-items:center;gap:8px;margin-top:13px}.pipeline span{display:flex;align-items:center;justify-content:center;min-height:32px;padding:0 8px;border:1px solid #e1e7ef;border-radius:var(--qui-radius-md);background:var(--qui-surface);color:var(--qui-text-soft);font-size:var(--qui-text-xs);font-weight:700;text-align:center}.pipeline i{font-style:normal;text-align:center;color:var(--qui-faint);font-size:var(--qui-text-sm)}
    .actions{display:flex;justify-content:flex-end;gap:8px;margin-top:16px;flex-wrap:wrap}.primary{display:inline-flex;align-items:center;justify-content:center;height:34px;min-height:34px;padding:0 14px;border:0;border-radius:var(--qui-radius-md);background:var(--qui-accent);color:var(--qui-on-accent);text-decoration:none;font-size:var(--qui-text-xs);font-weight:750}.primary:hover{background:var(--qui-accent-hover)}.primary:disabled{opacity:.5;cursor:not-allowed}.secondary,.secondary-link{display:inline-flex;align-items:center;height:34px;padding:0 12px;border:1px solid var(--qui-border);border-radius:var(--qui-radius-md);background:var(--qui-surface);color:var(--qui-text-soft);text-decoration:none;font-size:var(--qui-text-xs);font-weight:700}.secondary:hover,.secondary-link:hover{background:var(--qui-surface-muted);border-color:#cfd8e4}
    .result-section{padding-bottom:18px}.success-head{display:flex;justify-content:space-between;gap:20px;align-items:flex-start}.success-head h2{margin:5px 0;color:var(--qui-text);font-size:var(--qui-text-2xl)}.success-head p{max-width:720px;margin:0;color:var(--qui-muted);font-size:var(--qui-text-xs);line-height:1.55}.state-pill{padding:6px 9px;border:1px solid #ccebd9;border-radius:var(--qui-radius-pill);background:#f0faf4;color:var(--qui-positive);font-size:var(--qui-text-xs);font-weight:800;white-space:nowrap}
    .result-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin-top:16px}.result-grid>div{min-width:0;padding:13px;border:1px solid var(--qui-border);border-radius:var(--qui-radius-md);background:var(--qui-surface-muted)}.result-grid small,.result-grid strong,.result-grid span{display:block}.result-grid small{color:var(--qui-faint);font-size:var(--qui-text-xs);font-weight:700;text-transform:uppercase;letter-spacing:.06em}.result-grid strong{margin-top:6px;color:var(--qui-text);font-size:var(--qui-text-xs);overflow-wrap:anywhere}.result-grid span{margin-top:4px;color:var(--qui-faint);font-size:var(--qui-text-xs);line-height:1.35}
    .timeline{display:grid;margin-top:18px}.timeline div{position:relative;padding:12px 14px 12px 32px;border-left:1px solid var(--qui-border)}.timeline div:before{content:"";position:absolute;left:-5px;top:17px;width:8px;height:8px;border:2px solid #cbd5e1;border-radius:50%;background:var(--qui-surface)}.timeline .done:before{border-color:#22c55e;background:#dcfce7}.timeline b,.timeline small{display:block}.timeline b{color:var(--qui-text);font-size:var(--qui-text-xs)}.timeline small{margin-top:4px;color:var(--qui-faint);font-size:var(--qui-text-xs);line-height:1.45}
    .status{display:flex;align-items:center;gap:8px;margin:0 28px 18px;padding:10px 12px;border:1px solid var(--qui-border);border-radius:var(--qui-radius-md);background:var(--qui-surface);color:var(--qui-muted);font-size:var(--qui-text-xs)}.status strong{color:var(--qui-text)}.status.error{border-color:#fecdd3;background:#fff1f2;color:#9f1239}.status.error strong{color:#9f1239}
    @media (max-width: 1200px){.grid{grid-template-columns:repeat(2,minmax(0,1fr))}.result-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.pipeline{grid-template-columns:repeat(5,minmax(0,1fr))}.pipeline i{display:none}}
    @media (max-width: 640px){.steps,.section,.status{margin-left:16px;margin-right:16px}.grid,.form-grid,.result-grid{grid-template-columns:1fr}.split-heading,.success-head{flex-direction:column}.pipeline{grid-template-columns:1fr}.actions{justify-content:flex-start}}
    @media (max-width: 640px){.steps,.section,.status{margin-left:0;margin-right:0}.section{padding:16px;border-left:0;border-right:0;border-radius:0}}
  `]})
