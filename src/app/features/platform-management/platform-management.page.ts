...
@Component({
 ...
 styles:[`
 :host{display:block;color:#202124;background:#f7f8fc}.platform{--ink:#202124;--muted:#667085;--border:#edf0f4}.eyebrow{display:block;color:#667085;font-size:9px;font-weight:800;letter-spacing:1.1px}.primary{display:inline-flex;align-items:center;height:36px;padding:0 14px;border-radius:8px;background:#f97316;color:#fff;text-decoration:none;font-size:10px;font-weight:700;box-shadow:0 4px 11px rgba(37,99,235,.15)}.primary:hover{background:#ea580c}.overview{display:flex;align-items:center;justify-content:space-between;gap:20px;margin:0 0 14px;padding:22px 24px;border:1px solid #edf0f4;border-radius:12px;background:#fff;box-shadow:0 2px 10px rgba(16,24,40,.055)}.overview-copy h2{margin:6px 0 7px;font-size:21px;letter-spacing:-.4px;color:#111827}.overview-copy p{max-width:760px;margin:0;color:var(--muted);font-size:10px;line-height:1.65}.overview-status{display:flex;align-items:center;gap:9px;min-width:205px;padding:10px 12px;border:1px solid #e5e7eb;border-radius:9px;background:#fafbfc}.status-dot{width:9px;height:9px;border-radius:50%;background:#087443;box-shadow:0 0 0 4px #ecfdf3}.overview-status div{display:flex;flex-direction:column}.overview-status b{font-size:10px;color:#111827}.overview-status small{margin-top:3px;color:#667085;font-size:8px}.section{margin-bottom:12px;padding:17px;border:1px solid #edf0f4;border-radius:12px;background:#fff;box-shadow:0 2px 10px rgba(16,24,40,.055)}.section header{margin-bottom:13px}.section h3{margin:5px 0 3px;font-size:15px;color:#111827}.section header p{margin:0;color:var(--muted);font-size:9px}.cards{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px}.card{position:relative;display:grid;grid-template-columns:38px 1fr auto;align-items:start;gap:11px;min-height:108px;padding:14px;border:1px solid #e5e7eb;border-radius:10px;background:#fff;text-decoration:none;color:inherit;box-shadow:0 4px 12px rgba(16,24,40,.035);transition:.16s}.card:hover{transform:translateY(-2px);border-color:#fed7aa;box-shadow:0 9px 24px rgba(16,24,40,.07)}.card.featured{border-color:#cfe0ff;background:#f8fbff}.card-icon{display:grid;width:38px;height:38px;place-items:center;border-radius:9px;font-size:15px;font-weight:800}.card-icon.blue{background:#eff6ff;color:#2563eb}.card-icon.green{background:#ecfdf3;color:#087443}.card-icon.violet{background:#f3efff;color:#7c3aed}.card-icon.amber{background:#fffaeb;color:#b54708}.card div b{display:block;margin-top:1px;font-size:11px;color:#111827}.card div p{margin:5px 0 0;color:#667085;font-size:8.5px;line-height:1.55}.card>strong{align-self:center;color:#ea580c;font-size:9px;white-space:nowrap}.section:last-child{margin-bottom:0}@media(max-width:950px){.cards{grid-template-columns:repeat(2,minmax(0,1fr))}.overview{align-items:flex-start;flex-direction:column}.overview-status{min-width:0}}@media(max-width:650px){.cards{grid-template-columns:1fr}.primary{margin-top:6px}.overview{padding:18px}.section{padding:14px}}
 `]
})
