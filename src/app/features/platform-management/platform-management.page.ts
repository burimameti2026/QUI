...
@Component({
 ...
 qai-page-header .page-header a.primary{border-color:var(--brand-primary)!important;background:var(--brand-primary)!important;color:#fff!important;box-shadow:none!important}
 qai-page-header .page-header a.primary:hover{background:var(--brand-primary-hover)!important}
 ...
 .platform-metrics{display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr))!important;gap:10px!important;margin:0 20px 14px!important}.platform-metrics article{position:relative!important;display:flex!important;gap:11px!important;min-height:92px!important;padding:15px 16px!important;border:1px solid #e3e8ef!important;border-radius:10px!important;background:#fff!important;box-shadow:0 2px 5px rgba(16,24,40,.035),0 7px 18px rgba(36,60,88,.05)!important}.platform-metrics article:before{content:""!important;position:absolute!important;top:0!important;left:0!important;width:100%!important;height:3px!important;border-radius:10px 10px 0 0!important;background:var(--brand-accent)!important}.platform-metrics article:nth-child(2):before{background:#7c3aed!important}.platform-metrics article:nth-child(3):before{background:#059669!important}.platform-metrics article:nth-child(4):before{background:#d97706!important}.metric-icon{display:grid!important;width:32px!important;height:32px!important;flex:0 0 32px!important;place-items:center!important;border-radius:8px!important;font-size:11px!important;font-weight:800!important}.metric-icon.blue{background:var(--brand-accent-soft)!important;color:var(--brand-accent)!important}.metric-icon.violet{background:#f2edff!important;color:#7c3aed!important}.metric-icon.green{background:#eaf9f1!important;color:#059669!important}.metric-icon.amber{background:#fff5df!important;color:#d97706!important}.platform-metrics small,.platform-metrics em{display:block!important;color:#667085!important;font-size:8px!important;line-height:1.35!important;font-style:normal!important}.platform-metrics strong{display:block!important;margin:5px 0 2px!important;color:#172033!important;font-size:16px!important;line-height:1!important}.platform-metrics em{color:#8293a7!important}
 .section{margin:0 20px 14px!important;padding:16px!important;border:1px solid #e3e8ef!important;border-radius:12px!important;background:#fff!important;box-shadow:0 2px 5px rgba(16,24,40,.035),0 7px 18px rgba(36,60,88,.05)!important}.section header{margin-bottom:13px!important}.section h3{margin:4px 0 3px!important;color:var(--brand-primary)!important;font-size:14px!important;font-weight:750!important}.section header p{margin:0!important;color:#8293a7!important;font-size:9px!important}
 .cards{display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:10px!important}.card{position:relative!important;display:grid!important;grid-template-columns:38px minmax(0,1fr) auto!important;align-items:start!important;gap:11px!important;min-height:108px!important;padding:14px!important;border:1px solid #e3e8ef!important;border-radius:10px!important;background:#fff!important;text-decoration:none!important;color:inherit!important;box-shadow:0 2px 5px rgba(16,24,40,.025),0 5px 15px rgba(36,60,88,.035)!important;transition:.16s!important}.card:hover{transform:translateY(-1px)!important;border-color:var(--brand-primary-border)!important;box-shadow:0 7px 20px rgba(36,60,88,.07)!important}.card.featured{border-color:var(--brand-primary-border)!important;background:#fffaf6!important}.card-icon{display:grid!important;width:38px!important;height:38px!important;place-items:center!important;border-radius:9px!important;font-size:14px!important;font-weight:800!important}.card-icon.blue{background:var(--brand-accent-soft)!important;color:var(--brand-accent)!important}.card-icon.green{background:#eaf9f1!important;color:#059669!important}.card-icon.violet{background:#f2edff!important;color:#7c3aed!important}.card-icon.amber{background:#fff5df!important;color:#d97706!important}.card div{min-width:0!important}.card div b{display:block!important;margin-top:1px!important;color:var(--brand-primary)!important;font-size:10px!important;font-weight:750!important}.card div p{margin:5px 0 0!important;color:#667085!important;font-size:8px!important;line-height:1.55!important}.card>strong{align-self:center!important;color:var(--brand-primary)!important;font-size:8px!important;white-space:nowrap!important}
 .section:last-child{margin-bottom:24px!important}
 .platform qai-page-header .page-header a.primary,.platform qai-page-header .page-header a.primary:visited{background:var(--brand-primary)!important;border-color:var(--brand-primary)!important;color:#fff!important;box-shadow:none!important}.platform qai-page-header .page-header a.primary:hover,.platform qai-page-header .page-header a.primary:focus{background:var(--brand-primary-hover)!important;border-color:var(--brand-primary-hover)!important;color:#fff!important}
