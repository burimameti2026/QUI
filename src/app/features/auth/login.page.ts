...
@Component({
  ...
  styles: [`
    ...
    .login { min-height:100vh; display:grid; grid-template-columns:minmax(0,1.08fr) minmax(420px,.92fr); background:#f3f6fb; color:#17212b; }
    .login-hero { position:relative; overflow:hidden; padding:44px clamp(40px,6vw,96px); background:#14233b; color:#fff; display:flex; flex-direction:column; }
    .login-hero:after { content:""; position:absolute; width:460px; height:460px; right:-180px; bottom:-180px; border:1px solid rgba(67,126,234,.2); border-radius:50%; box-shadow:0 0 0 80px rgba(67,126,234,.035),0 0 0 160px rgba(67,126,234,.02); pointer-events:none; }
    .brand { display:flex; align-items:center; gap:12px; position:relative; z-index:1; }
    .brand-mark { width:38px; height:38px; display:grid; place-items:center; border-radius:10px; background:#3b82f6; color:#fff; font-size:20px; font-weight:800; }
    .brand div { display:grid; grid-template-columns:auto auto; column-gap:4px; align-items:center; }.brand b { font-size:19px; font-weight:700; }.brand strong { color:#60a5fa; font-size:19px; }.brand small { grid-column:1/-1; color:#a9b7c9; font-size:10px; letter-spacing:.08em; text-transform:uppercase; margin-top:1px; }
    .hero-copy { max-width:680px; margin:auto 0; position:relative; z-index:1; }.eyebrow,.form-eyebrow { color:#60a5fa; font-size:11px; font-weight:700; letter-spacing:.16em; }.hero-copy h1 { max-width:620px; margin:18px 0 16px; font-size:clamp(34px,4vw,52px); line-height:1.08; letter-spacing:-.035em; font-weight:650; }.hero-copy h1 em { color:#60a5fa; font-style:normal; }.hero-copy p { max-width:590px; margin:0 0 30px; color:#bdc9d8; font-size:15px; line-height:1.7; }
    .workflow { max-width:620px; padding:18px; border:1px solid rgba(255,255,255,.1); border-radius:12px; background:rgba(255,255,255,.045); backdrop-filter:blur(8px); }.workflow-head { display:flex; align-items:center; gap:10px; padding-bottom:14px; border-bottom:1px solid rgba(255,255,255,.08); }.workflow-head span { color:#60a5fa; font-size:9px; font-weight:700; letter-spacing:.12em; }.workflow-head b { font-size:12px; font-weight:600; flex:1; }.workflow-head i { font-style:normal; color:#93c5fd; font-size:9px; font-weight:700; }.workflow-step { min-height:58px; display:flex; align-items:center; gap:12px; padding:10px 4px; border-bottom:1px solid rgba(255,255,255,.07); }.workflow-step:last-child{border-bottom:0}.workflow-step>span { width:28px;height:28px;border-radius:8px;display:grid;place-items:center;border:1px solid rgba(255,255,255,.12);color:#a9b7c9;font-size:10px;font-weight:700; }.workflow-step.done>span,.workflow-step.active>span { background:#3b82f6;color:#fff;border-color:#3b82f6; }.workflow-step div{flex:1}.workflow-step b{display:block;font-size:12px;font-weight:600}.workflow-step small{display:block;margin-top:3px;color:#94a7bd;font-size:10px}.workflow-step>i{font-style:normal;color:#60a5fa;font-size:9px;font-weight:700}.benefits{display:flex;gap:18px;flex-wrap:wrap;margin-top:22px;color:#94a7bd;font-size:10px}.benefits span:first-child{color:#c8d3e0}
    .login-panel { display:flex; align-items:center; justify-content:center; padding:40px; background:#fff; }.form-wrap{width:min(390px,100%)}.form-icon{width:42px;height:42px;border-radius:11px;background:#eaf2ff;color:#2563eb;display:grid;place-items:center;font-size:20px;font-weight:700;margin-bottom:20px}.form-wrap h2{margin:10px 0 7px;font-size:30px;line-height:1.15;letter-spacing:-.025em;font-weight:650}.form-intro{margin:0 0 28px;color:#71808a;font-size:13px;line-height:1.5}.form-wrap form{display:grid;gap:17px}.form-wrap label{display:grid;gap:7px}.form-wrap label span{font-size:11px;font-weight:650;color:#34434d}.form-wrap input{width:100%;height:46px;padding:0 13px;border:1px solid #d6deea;border-radius:8px;background:#fff;color:#17212b;outline:none;transition:border-color .15s,box-shadow .15s}.form-wrap input::placeholder{color:#a4afb4}.form-wrap input:focus{border-color:#4f83dc;box-shadow:0 0 0 3px rgba(79,131,220,.12)}.form-meta{display:flex;justify-content:space-between;color:#8a969b;font-size:10px;margin-top:-3px}.form-wrap button{height:47px;border:0;border-radius:8px;background:#2563eb;color:#fff;font-weight:650;font-size:13px;display:flex;align-items:center;justify-content:center;gap:12px;box-shadow:0 5px 14px rgba(37,99,235,.2);transition:background .15s,transform .15s}.form-wrap button:hover:not(:disabled){background:#1d4ed8;transform:translateY(-1px)}.form-wrap button:disabled{opacity:.6;cursor:not-allowed}.form-wrap button span{font-size:17px}.error{padding:11px 12px;border:1px solid #f1caca;background:#fff5f5;color:#b33e3e;border-radius:8px;font-size:11px;line-height:1.45}.demo{margin-top:22px;padding:13px 14px;border:1px solid #e0e6ef;border-radius:9px;background:#f7f9fc}.demo span{display:block;color:#2563eb;font-size:9px;font-weight:700;letter-spacing:.1em}.demo b{display:block;margin-top:4px;font-size:12px}.demo small{display:block;margin-top:3px;color:#8a969b;font-size:10px}.copyright{display:block;margin-top:24px;color:#a1aaae;font-size:9px;text-align:center;letter-spacing:.04em}
